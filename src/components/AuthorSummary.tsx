...
export const AuthorSummary = (props: IProps) => {
    const nameDisplay = () => {
        const {author: {displayName, userName, idOnPlatform}} = props;
        if (!displayName) {
    ...
    return (
        <div>
            <div class="d-inline-block">
                <img width={40} height={40} alt={`${nameDisplay()}'s PFP`} src={props.author.profileImages[0]?.url}/>
            </div>
            <div class="d-inline-block">
                <Show when={props.author.urlOnPlatform} fallback={nameDisplay()}>
